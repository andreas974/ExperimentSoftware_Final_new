...
public class ClientMessageReceiver extends MessageReceiver<ServerMessage> {
		 ...
		 * @throws IOException
		 */
		@Override public void routeMessage(ServerMessage message) throws IOException, IllegalAccessException, ClassNotFoundException, InstantiationException, RecordingException, InterruptedException {
