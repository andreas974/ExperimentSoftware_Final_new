 ...
 */
public class ContinuousCompetitionQuestionnaireCharacteristics extends QuestionnaireScreen {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -8841977439730389225L;

	public ContinuousCompetitionQuestionnaireCharacteristics(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
