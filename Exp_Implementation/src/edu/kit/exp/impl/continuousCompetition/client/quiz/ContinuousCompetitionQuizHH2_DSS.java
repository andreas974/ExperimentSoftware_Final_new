 ...
 */
public class ContinuousCompetitionQuizHH2_DSS extends QuizScreen {

    public ContinuousCompetitionQuizHH2_DSS(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
